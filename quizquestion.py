...
questions_england = [("What is the capital of the UK?", "London"), ("In what country can you find a clock tower called the Big Ben?", "UK")]
questions_france = [("What is the capital of France?", "Paris"), ("In which city is the Eiffel Tower located?", "Paris")]
questions_germany = [("What is the capital of Germany", "Berlin"), ("Where in the world can you find the Cologne Cathedral?", "Germany")]
questions_other = [("Which of the following countries has the highest population? France, Germany, Italy?", "Germany")]
